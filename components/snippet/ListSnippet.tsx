    ...
    <Section name="list-snippet">
      <Grid className="pt-5 gap-y-5 xl:gap-y-0">
        ...
        <label class="block col-span-full relative">
          <input
            type="text"
            class="mt-1 block w-full bg-dark-300 rounded-lg px-4 py-2 xl:py-4 xl:px-6 placeholder-gray-500 text-sm xl:mb-7 xl:mt-0 "
            placeholder="Type your favorite snippet ..."
          />
          <IconifyIcon
            icon="heroicons-solid:search"
            class="h-5 w-5 text-gray-300 absolute right-4 top-3 xl:top-5 xl:right-6"
          />
        </label>
